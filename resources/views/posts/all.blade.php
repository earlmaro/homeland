                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-4">
                                        ...
                                        <div class="carousel-item {{$images[0] == $image ? "active" : ""}}">
                                            <img src="{{url('/images/'.$image)}}" class=" img d-block w-100">
                                            <div class="overlay">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            ...
                                            <p >TYPE OF PROPERTY: {{$userPost->proptype}}</p>
                                            <p >LANDMARK: {{$userPost->landmark}}</p>
                                            <p >ADDRESS: {{$userPost->address}}</p>
                                            {{-- <p>Moderator: {{$approvedPost->moderator}}</p> --}}
                                            {{-- <p>star: {{$approvedPost->user->star}}</p> --}}
                                            <p>vacancy: {{$userPost->vacancy}}</p>
                                            <p >describtion: {{$userPost->propdesc}}</p>
                                            {{-- <p>Email: {{$userPost->user->email}}</p> --}}
                                            <p class="card-text">price range: {{$userPost->worth}}</p>
