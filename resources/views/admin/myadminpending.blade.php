    ...
    <div class="container-fluid">
        <div class="row ">
            ...
            <div class="col--7 col-sm-12 col-md-7 text-center mid">
                ...
                @foreach($adminpending as $adminpend)
                {{-- @foreach($users as $user) --}}
                <div class="row py-4">
                    <a href="/admin/{{$adminpend->id}}">
                        <div class="col-12">
                                    ...
                                    <div class="col-md-8">
                                            <div class="card-body">
                                                    ...
                                                    {{-- <p>Advertiser: {{$approvedPost->user->firstname}} {{$approvedPost->user->lastname}}</p> --}}
                                                      <p>TYPE OF PROPERTY: {{$adminpend->proptype}}</p>
                                                      <p>LANDMARK: {{$adminpend->landmark}}</p>
                                                      <p>ADDRESS: {{$adminpend->address}}</p>
